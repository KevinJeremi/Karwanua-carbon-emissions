                ...
                {indicators.map((indicator, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`text-sm font-semibold ${indicator.status === 'warning' ? 'text-orange-600' : 'text-green-600'
                                }`}>
                                {indicator.value}
                            </span>
                            <div className={`w-2 h-2 rounded-full ${indicator.status === 'warning' ? 'bg-orange-400' : 'bg-green-400'
                                }`} />
                        </div>
                    </motion.div>
                ))}
